...
public class GoldenChestBlockEntityRenderer extends ChestBlockEntityRenderer<GoldenChestBlockEntity> {
    ...
    public GoldenChestBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
        super(ctx);
    ...
    protected SpriteIdentifier getTexture(GoldenChestBlockEntity blockEntity, ChestType chestType) {
    ...
    @Override
    public void render(GoldenChestBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
