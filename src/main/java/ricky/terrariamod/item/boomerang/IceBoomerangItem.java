...
import ricky.terrariamod.entity.weapon.IceBoomerangEntity;
import ricky.terrariamod.item.AttackableItem;

public class IceBoomerangItem extends Item implements AttackableItem {
    public IceBoomerangItem(Settings settings) {
        super(settings);
    }
    ...
    public void attack(World world, PlayerEntity playerEntity, Hand hand) {
        if (!world.isClient) {
            ...
            // IceBoomerangEntity を生成
            IceBoomerangEntity boomerangEntity = new IceBoomerangEntity(world, playerEntity, boomerang);
