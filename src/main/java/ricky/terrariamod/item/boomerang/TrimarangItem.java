...
import ricky.terrariamod.entity.weapon.TrimarangEntity;
import ricky.terrariamod.item.AttackableItem;

public class TrimarangItem extends Item implements AttackableItem {
    public TrimarangItem(Settings settings) {
        super(settings);
    }
    ...
    public void attack(World world, PlayerEntity playerEntity, Hand hand) {
        if (!world.isClient) {
            ...
            // TrimarangEntity を生成
            TrimarangEntity boomerangEntity = new TrimarangEntity(world, playerEntity, boomerang);
