...
import ricky.terrariamod.entity.weapon.ShroomerangEntity;
import ricky.terrariamod.item.AttackableItem;

public class ShroomerangItem extends Item implements AttackableItem {
    public ShroomerangItem(Settings settings) {
        super(settings);
    }
    ...
    public void attack(World world, PlayerEntity playerEntity, Hand hand) {
        if (!world.isClient) {
            ...
            // ShroomerangEntity を生成
            ShroomerangEntity boomerangEntity = new ShroomerangEntity(world, playerEntity, boomerang);
