...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.DEEPSLATE_ORICHALCUM_ORE, copperLikeOreDrops(ModBlocks.DEEPSLATE_ORICHALCUM_ORE, ModItems.ORICHALCUM_RAW));
        addDrop(ModBlocks.ADAMANTITE_ORE, copperLikeOreDrops(ModBlocks.ADAMANTITE_ORE, ModItems.ADAMANTITE_RAW));
        addDrop(ModBlocks.DEEPSLATE_ADAMANTITE_ORE, copperLikeOreDrops(ModBlocks.DEEPSLATE_ADAMANTITE_ORE, ModItems.ADAMANTITE_RAW));
