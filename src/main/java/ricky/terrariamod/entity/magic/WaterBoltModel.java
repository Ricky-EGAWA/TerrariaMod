...
public class WaterBoltModel<T extends WaterBoltEntity> extends SinglePartEntityModel<T> {
	private final ModelPart ball;
	public WaterBoltModel(ModelPart root) {
	...
	@Override
	public void setAngles(WaterBoltEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
	@Override
