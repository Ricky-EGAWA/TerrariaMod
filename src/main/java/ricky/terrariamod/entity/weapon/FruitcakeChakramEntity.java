...
public class FruitcakeChakramEntity extends PersistentProjectileEntity {
    ...
    public FruitcakeChakramEntity(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
        super(entityType, world);
        this.boomerangStack = new ItemStack(ModItems.FRUITCAKE_CHAKRAM); // デフォルトのアイテムスタックを設定
    }

    public FruitcakeChakramEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.CANDY_CANE_CHAKRAM, owner, world);
