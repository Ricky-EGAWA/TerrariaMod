...
public class SniperBulletEntity extends PersistentProjectileEntity {
    private static final TrackedData<Integer> COLOR;

    public SniperBulletEntity(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
        super(entityType, world);
    }

    public SniperBulletEntity(World world, double x, double y, double z) {
        super(ModEntities.MUSKET_BALL, x, y, z, world);
    }

    public SniperBulletEntity(World world, LivingEntity owner) {
    ...
    static {
        COLOR = DataTracker.registerData(SniperBulletEntity.class, TrackedDataHandlerRegistry.INTEGER);
    }
    @Override
