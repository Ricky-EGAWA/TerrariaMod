...
public class EnchantedSwordEntity extends PersistentProjectileEntity {
    ...
    public EnchantedSwordEntity(EntityType<? extends EnchantedSwordEntity> entityType, World world) {
        super(entityType, world);
        this.tridentStack = new ItemStack(ModItems.ENCHANTED_SWORD);
    }

    public EnchantedSwordEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.ENCHANTED_SWORD, owner, world);
        this.tridentStack = new ItemStack(ModItems.ENCHANTED_SWORD);
