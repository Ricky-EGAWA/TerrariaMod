...
public class DungeonSlimeRenderer
        extends MobEntityRenderer<SlimeEntity, SlimeModel<SlimeEntity>> {
    private static final Identifier TEXTURE = new Identifier(TerrariaMod.MOD_ID,"textures/entity/dungeon_slime.png");

    public DungeonSlimeRenderer(EntityRendererFactory.Context context) {
        super(context, new SlimeModel(context.getPart(ModModelLayers.DUNGEON_SLIME_LAYER)), 0.25f);
