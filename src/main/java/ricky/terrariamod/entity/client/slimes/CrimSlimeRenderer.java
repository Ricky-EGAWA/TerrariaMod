...
public class CrimSlimeRenderer
        extends MobEntityRenderer<SlimeEntity, SlimeModel<SlimeEntity>> {
    private static final Identifier TEXTURE = new Identifier(TerrariaMod.MOD_ID,"textures/entity/crim_slime.png");

    public CrimSlimeRenderer(EntityRendererFactory.Context context) {
        super(context, new SlimeModel(context.getPart(ModModelLayers.CRIM_SLIME_LAYER)), 0.25f);
