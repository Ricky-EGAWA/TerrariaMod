...
public class IceSlimeOverlayFeatureRenderer<T extends LivingEntity>
        extends FeatureRenderer<T, SandSlimeModel<T>> {
    private final EntityModel<T> model;

    public IceSlimeOverlayFeatureRenderer(FeatureRendererContext<T, SandSlimeModel<T>> context, EntityModelLoader loader) {
        super(context);
