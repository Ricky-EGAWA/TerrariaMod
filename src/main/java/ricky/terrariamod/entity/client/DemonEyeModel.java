...
public class DemonEyeModel<T extends DemonEyeEntity> extends SinglePartEntityModel<T> {
	...
	@Override
	public void setAngles(DemonEyeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
	@Override
	public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
		demon_eye.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
	}
