...
public class JungleBatEntityModel extends SinglePartEntityModel<JungleBatEntity> {
    ...
    public JungleBatEntityModel(ModelPart root) {
        this.root = root;
    ...
    @Override
    public void setAngles(JungleBatEntity batEntity, float f, float g, float h, float i, float j) {
