...
public class LavaBatEntityModel extends SinglePartEntityModel<LavaBatEntity> {
    ...
    public LavaBatEntityModel(ModelPart root) {
        this.root = root;
    ...
    @Override
    public void setAngles(LavaBatEntity batEntity, float f, float g, float h, float i, float j) {
